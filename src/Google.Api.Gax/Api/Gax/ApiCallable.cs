...
namespace Google.Api.Gax
{
    ...
    /// <param name="callSettings">The settings to apply to this call.</param>
    /// <returns>A task representing the API call; the result of the completed task will be the API response.</returns>
    public delegate Task<TResponse> ApiCallable<TRequest, TResponse>(TRequest request, CallSettings callSettings)
